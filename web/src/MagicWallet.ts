import {
    ...
    AccountRecordsQuery,
    TransactionId,
    PublicKey, Provider, Wallet,
} from "@hashgraph/sdk";
import { shuffle } from '@magic-ext/hedera'
import {Transaction} from "@hashgraph/sdk/lib/Signer";
...
export class MagicWallet {
     ...
     */
    constructor(accountId: AccountId | string, provider: Provider, publicKey: string, magicSign: (message: Uint8Array) => any) {
